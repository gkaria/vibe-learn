...
if [ "$MODE" = "global" ]; then
  echo "✓ OpenCode commands installed (~/.config/opencode/commands/learn.md, digest.md, quiz.md, explain.md)"
  echo "✓ OpenCode plugin installed (~/.config/opencode/plugins/vibe-learn.js)"
else
  echo "✓ OpenCode commands installed (.opencode/commands/learn.md, digest.md, quiz.md, explain.md)"
